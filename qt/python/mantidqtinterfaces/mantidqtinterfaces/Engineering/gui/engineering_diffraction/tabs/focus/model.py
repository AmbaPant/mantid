...
class FocusModel(object):
    ...
    def focus_run(self, sample_paths: list, vanadium_path: str, plot_output: bool, rb_num: str,
        ...
        focused_files, focused_files_gsas2 = EnggUtils.focus_run(sample_paths, vanadium_path, plot_output, rb_num, calibration, save_dir,
                                                                 full_calib)
        self._last_focused_files.extend(focused_files)
        self._last_focused_files_gsas2.extend(focused_files_gsas2)
